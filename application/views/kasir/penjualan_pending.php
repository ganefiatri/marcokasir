            ...
            <table id="tbPending" class="table table-bordered table-striped table-responsive">
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td align="center"><a href="<?php echo base_url('kasir/mesin-kasir/') . $key->no_faktur_penjualan ?>">Lanjut</a> | <a onclick="return confirm('Yakin hapus faktur ini?')" href="<?php echo base_url('kasir/hapus-faktur/') . $key->no_faktur_penjualan ?>">Hapus</a> | <form id="input" action="<?php echo base_url('kasir/cetak_struk_sementara/') ?>" method="post">
                      <input type="hidden" name="nofak_print" id="nofak_print" value="<?php echo $key->no_faktur_penjualan ?>">
                        <a href="javascript:window.open('<?php echo base_url('kasir/cetak_struk_sementara/') ?>', 'Cetak Struk Pending', 'width=200,height=150');" onclick="document.getElementById('input').submit();">Print</a>
                    </form>
                  </td>
                </tr>
                <?php endforeach?>
