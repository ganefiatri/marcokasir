...
<head>
    ...
    <meta name="author" content="ganefiatri" />
    <link rel="icon" type="image/png" href="<?php echo base_url('assets/') ?>/img/favicon.png"/>
    <!--[if IE]>
        <meta http-equiv="X-UA-Compatible" content="IE=edge,chrome=1">
        <![endif]-->
    <title>Marendal.co</title>
        ...
        <div class="container">
            <div class="navbar-header" >
                ...
                <a href="<?php echo base_url('dashboard/') ?>" style="text-align:center">
                    <img height="100px" src="<?php echo base_url() ?>assets/img/logo.png" />
                </a>
                <h2 style="display: inline; text-transform: uppercase;margin-left: 10px; "><?php echo $namatoko ?></h2>
            </div>
        </div>
    </div>
<?php
                ...
                <div class="col-md-12">
                    <div class="navbar-collapse collapse ">
                        <ul id="menu-top" class="nav navbar-nav navbar-left">
                            ...
                            <?php if ($hak != 'kasir'): ?>
                            <li class="dropdown">
                                <a href="#" class="dropdown-toggle" id="ddlmenuItem" data-toggle="dropdown">MENU Marendal<i class="fa fa-angle-down"></i></a>
                                <ul class="dropdown-menu" role="menu" aria-labelledby="ddlmenuItem">
                                    ...
                                    <li role="presentation"><a role="menuitem" tabindex="-1" href="<?php echo base_url('gudang/edit-stok/') ?>">INPUT STOK BAHAN</a></li>
                            ...
                            <?php endif?>
                            <li><a href="<?php echo base_url('login/logout/') ?>"><strong style="color: red">HUTANG</strong></a></li>
